...
Timetable.Renderer = function(t) {
  ...
  function() {
    ...
    function s(t) {
      // Take the time 0:00 to 23:00 and turn into readable times
      // Example: 0:00 = 12:00 am
      var e = t < 10 ? "" : "";
      var amPM = " am";
      if (t > 12) {
        t = t - 12;
    ...
    Timetable.prototype = {
      ...
      addEvent: function(t, e, n, o, showID, programID, type, nolaRoot, a) {
        // console.log("Title: " + t);
        // console.log("Show: " + showID);
        // console.log("Program: " + programID);
        // console.log("Type: " + type);
        // console.log("Nola Root: " + nolaRoot);
        // console.log("--------------------");
      ...
      draw: function(t) {
        ...
        function d(t, e) {
          ...
          link.href = "/showKesiride/" + t.program + "/" + t.slug, c.className = o ? "time-entry " + t.options["class"] : "time-entry", c.style.width = h(t), c.style.left = m(t), s.textContent = t.name
        }

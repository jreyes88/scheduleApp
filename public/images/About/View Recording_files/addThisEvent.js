...
Added a hack in the addThisEvent Plugin,
in a function called addThisEvent.cli,
...
with
    ...
    if (a == 'outlook') {
        c = $('#outlookCalendarURL').val();
        nw = false
    }

so that the plugin calls our own controller just for outlook

Same change was done for ical too

Line 307-- added '_self' to open the calendars on the same page, to avoid popups when clicked programatically
            ...
            for (var d = 0; d < c.length; d += 1) {
                ...
                if (str == 'addthisevent') {
                    ...
                    for (var m = 0; m < g.length; m += 1) {
                        if (g[m].className == '_url') {
                            g[m].style.display = 'none'
                        }
                        if (g[m].className == '_start') {
                            g[m].style.display = 'none';
                            f += '&dstart=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_end') {
                            g[m].style.display = 'none';
                            f += '&dend=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_zonecode') {
                            g[m].style.display = 'none';
                            f += '&dzone=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_summary') {
                            g[m].style.display = 'none';
                            f += '&dsum=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_description') {
                            g[m].style.display = 'none';
                            f += '&ddesc=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_location') {
                            g[m].style.display = 'none';
                            f += '&dloca=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_organizer') {
                            g[m].style.display = 'none';
                            f += '&dorga=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_organizer_email') {
                            g[m].style.display = 'none';
                            f += '&dorgaem=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_attendees') {
                            g[m].style.display = 'none';
                            f += '&datte=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_all_day_event') {
                            g[m].style.display = 'none';
                            f += '&dallday=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_date_format') {
                            g[m].style.display = 'none';
                            f += '&dateformat=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_alarm_reminder') {
                            g[m].style.display = 'none';
                            f += '&alarm=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_recurring') {
                            g[m].style.display = 'none';
                            f += '&drule=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_uid') {
                            g[m].style.display = 'none';
                            f += '&uid=' + encodeURIComponent(g[m].innerHTML)
                        }
                        if (g[m].className == '_facebook_event') {
                            if (g[m].innerHTML != '') {
                                g[m].style.display = 'none';
                    ...
                    c[d].className = 'addthisevent-drop';
                    c[d].title = '';
